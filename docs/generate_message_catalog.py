...
REQUEST_MATRIX = {
    ...
    "CloneRepoMemberRequest": ("CloneRepoMemberResponse", "workspace_ops::handle_clone_repo_member", "repo/clone"),
    "DetachRepoMemberRequest": ("DetachRepoMemberResponse", "workspace_ops::handle_detach_repo_member", "repo/detach"),
    "AttachRepoMemberRequest": ("AttachRepoMemberResponse", "workspace_ops::handle_attach_repo_member", "repo/attach"),
    ...
    "FetchRequest": ("FetchResponse", "workspace_ops::handle_fetch", "fetch"),
