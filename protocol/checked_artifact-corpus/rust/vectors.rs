...
pub static VECTORS: &[(&str, &str, &str)] = &[
    ...
    ("CheckedAuthorityV1", "CheckedAuthorityV1", ""),
    ("CheckedBarrierIntentV1", "CheckedBarrierIntentV1", ""),
    ("CheckedCatalogBootstrapV1", "CheckedCatalogBootstrapV1", ""),
    ...
    ("CheckedDurablePathComponentV1", "CheckedDurablePathComponentV1", "a401430101020200034303010204a801010243020102030004430401020543050102064306010207430701020843080102"),
    ("CheckedDurablePathV1", "CheckedDurablePathV1", "a10181a401430101020200034303010204a801010243020102030004430401020543050102064306010207430701020843080102"),
    ("CheckedInfrastructureV1", "CheckedInfrastructureV1", ""),
    ("CheckedManagedBootstrapComponentV1", "CheckedManagedBootstrapComponentV1", ""),
    ("CheckedManagedBootstrapInputV1", "CheckedManagedBootstrapInputV1", "a201430101020219012c"),
    ("CheckedManagedParentBootstrapIntentV1", "CheckedManagedParentBootstrapIntentV1", ""),
...
pub fn reencode(message: &str, c: &crate::Cbor) -> crate::Cbor {
    match message {
        ...
        "CheckedDurablePathComponentV1" => crate::CheckedDurablePathComponentV1::from_cbor(c).expect("corpus decode: CheckedDurablePathComponentV1").to_cbor(),
        "CheckedDurablePathV1" => crate::CheckedDurablePathV1::from_cbor(c).expect("corpus decode: CheckedDurablePathV1").to_cbor(),
